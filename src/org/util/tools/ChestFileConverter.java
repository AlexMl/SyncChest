...
public class ChestFileConverter {
	...
	File chestFile = new File(this.plugin.getDataFolder().getPath() + "/chests.yml");
	...
	File mainChestFolder = new File(this.plugin.getDataFolder().getPath() + "/Chests/Main");
	File relatedChestFolder = new File(this.plugin.getDataFolder().getPath() + "/Chests/Related");
	File hopperFolder = new File(this.plugin.getDataFolder().getPath() + "/Hoppers");
	...
	if (chestFileExists()) {
	    ...
	    chestFile.renameTo(new File(this.plugin.getDataFolder().getPath() + "/chests.old.yml"));
	    return;
	}
    }
}
